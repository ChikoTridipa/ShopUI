...
use Shop\Modals\elements\{Dropdown, Input, Button, Label, Slider, StepSlider, Toggle};
...
use Shop\Modals\windows\{CustomForm, ModalWindow, SimpleForm};
...
public $Blocks = [
  ...
  public function sendMainShop(Player $player){
    $ui = new SimpleForm("§lShop§r","              Buy And Sell Items Here!");
